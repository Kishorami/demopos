...
class ControllerSales{
	...
	/*=============================================
	CHACKING SAME PRODUCT IF ALRADY ADDEDTO THE SALE LIST
	=============================================*/

	// static public function ctrSameProduct($data,$idproduct){
	...
	static public function ctrCreateSale(){
		...
		if(isset($_POST["newSale"])){
			...
			// var_dump($totalPurchasedProducts);
	...
	public function ctrDownloadReport(){
		...
		if(isset($_GET["report"])){
			...
			echo utf8_decode("<table border='0'> 
					...
					<tr> 
					<td style='font-weight:bold; border:1px solid #eee;'>BILL CODE</td> 
					<td style='font-weight:bold; border:1px solid #eee;'>CUSTOMERS</td>
					<td style='font-weight:bold; border:1px solid #eee;'>SELLERS</td>

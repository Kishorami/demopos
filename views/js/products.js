...
$(".productsTable tbody").on("click", "button.btnGenerateBarcode", function(){
        ...
        categoryData.append("idCategory",answer["idCategory"]);
         ...
         $.ajax({
            ...
            success:function(answer){
                ...
                $("#generateBarcode").val(answer["id"]);
                $("#generateBarcode").html(answer["Category"]);

            }

        })

         $("#editCodeBarcode").val(answer["id"]);

         $("#editDescriptionBarcode").val(answer["description"]);

         $("#editStockBarcode").val(answer["stock"]);

         $("#editBuyingPriceBarcode").val(answer["buyingPrice"]);

         $("#editSellingPriceBarcode").val(answer["sellingPrice"]);

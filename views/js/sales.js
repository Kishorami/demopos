...
if(localStorage.getItem("captureRange") != null){
	...
	$("#daterange-btn span").html('<i class= "fa fa-calender"></i> Date Range')
...
/*=============================================
ADDING PRODUCTS TO THE SALE FROM THE TABLE BY BARCODE
=============================================*/

// $(".salesTable tbody").on('keyup', "input.addProductSaleText", function (){
$(".salesTable tbody, .idProduct").on('keypress', function (e){
	...
	// var idProduct = $('.addProductSaleText').val();
...
function listProducts(){
	...
	var answer = isDuplicate(productsList);
	...
	if(answer == "false"){
		...
		var productsList4 = compressArray(productsList); //chacking duplicate

		var productsList2 = removeDuplicates(productsList4, it => it.id);  //removing duplicate

		console.log("unique :", productsList2);

		//correcting total price

		for(var i = 0; i < productsList2.length; i++){

			productsList2[i]["totalPrice"] = parseFloat(productsList2[i]["price"]) * productsList2[i]["quantity"]

		}

		var json = JSON.stringify(productsList2);

		$("#productsList").val(JSON.stringify(productsList2)); 
		// console.log("list :", productsList4);
		// console.log("unique :", productsList2);

		console.log("json :", json);
	}
	// var productsList2 = removeDuplicates(productsList, it => it.id);
	// console.log("productsList :", productsList);

	// var productsList3 = groupBy("id",productsList,productsList);
...
// function groupBy(propertyName, array,array2) {
//     var groupedElements = {};

 	...
 	data.append("validateUser", user);
      ...
      success: function(answer){ 
      	...
      	if(answer){
      		...
      		$("#newUserName").parent().after('<div class="alert alert-warning">This user name is already taken</div>');
...
$("#newemail").change(function(){
	...
	var data = new FormData();
 	data.append("validateEmail", user);
      ...
      success: function(answer){ 
      	...
      	if(answer){
      		...
      		$("#newemail").parent().after('<div class="alert alert-warning">This email is already in use</div>');

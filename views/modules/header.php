<header class="main-header">
	...
	<a href="" class="logo">
		...
		<span class="logo-mini">
			...
			<img  class="img-responsive" src="views/img/template/DemoLogo.png" style="padding:10px">
		...
		<span class="logo-lg">
			...
			<img class="img-responsive" src="views/img/template/DemoLogoLong.png" style="padding: 10px 0">

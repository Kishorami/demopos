          ...
          <div class="box-body">
            ...
            <div class="form-group">
              <div class="input-group">
                ...
                <input class="form-control input-lg" type="text" name="newPhone" placeholder="phone" data-inputmask="'mask':'(9999) 99999-999999'" data-mask required>
              </div>
            </div>
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="editPhone" id="editPhone" data-inputmask="'mask':'(9999) 99999-999999'" data-mask required>

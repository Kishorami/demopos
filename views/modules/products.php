  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="box-body">
        ...
        <input type="hidden" value="<?php echo $_SESSION['role']; ?>" id="hiddenProfile">
...
<div id="modalBarcode" class="modal fade" role="dialog">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post" enctype="multipart/form-data" action="extensions/barcode/barcode.php" target="_blank">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <select class="form-control input-lg" name="generateBarcode" readonly required>
                  
                  <option id="generateBarcode"></option>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" id="editCodeBarcode" name="editCodeBarcode" readonly required>
            ...
            <!-- INPUT FOR THE DESCRIPTION -->
             <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" id="editDescriptionBarcode" name="editDescriptionBarcode" required>
             ...
             <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="number" class="form-control input-lg" id="editStockBarcode" name="editStockBarcode" min="0" required>
             ...
             <div class="form-group row">
                ...
                <div class="col-xs-12 col-sm-6">
                  ...
                  <div class="input-group">
                    ...
                    <input type="number" class="form-control input-lg" id="editBuyingPriceBarcode" name="editBuyingPriceBarcode" step="any" min="0" required>
                ...
                <div class="col-xs-12 col-sm-6">
                  ...
                  <div class="input-group">
                    ...
                    <input type="number" class="form-control input-lg" id="editSellingPriceBarcode" name="editSellingPriceBarcode" step="any" min="0">
 ...
 -->
        ...
        <?php
          ...
          $GenerateBarcodeProduct = new controllerProducts();
          $GenerateBarcodeProduct -> ctrGenerateBarcode();
